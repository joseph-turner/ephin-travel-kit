...
>(({ className, ...props }, ref) => (
  <div className={cn('ui:absolute ui:left-0 ui:top-full ui:flex ui:justify-center')}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        'ui:origin-top-center ui:relative ui:mt-1.5 ui:h-[var(--radix-navigation-menu-viewport-height)] ui:w-full ui:overflow-hidden ui:rounded-md ui:border ui:border-neutral-200 ui:bg-white ui:text-neutral-950 ui:shadow data-[state=open]:ui:animate-in data-[state=closed]:ui:animate-out data-[state=closed]:ui:zoom-out-95 data-[state=open]:ui:zoom-in-90 md:ui:w-[var(--radix-navigation-menu-viewport-width)] dark:ui:border-neutral-800 dark:ui:bg-neutral-950 dark:ui:text-neutral-50',
        className
      )}
      ref={ref}
      {...props}
